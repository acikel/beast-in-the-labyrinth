...
#define UE_PROJECT_NAME BeastInTheLabyrinth
#define UE_TARGET_NAME BeastInTheLabyrinthEditor
#define UE_MODULE_NAME "BeastInTheLabyrinth"
...
#define BEASTINTHELABYRINTH_API DLLEXPORT
